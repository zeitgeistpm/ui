...
import { Web3AuthWallet, web3AuthWalletInstance } from "./util/web3auth-config";
...
const enabledWeb3Wallet = (keyPair: any) => {
  store.set(walletAtom, (state) => {
    return {
      ...state,
      wallet: { ...keyPair },
...
//TODO: see if there is a safe way to persist
/**
