...
import { create$, mainnet, ZeitgeistIpfs } from "@zeitgeistpm/sdk-next";
...
const DefaultLayout: FC = observer(({ children }) => {
  ...
  const sdk$ = useMemo(
    () =>
      create$(mainnet()),
    [store.userStore.gqlEndpoint, store.userStore.endpoint],
  );
  ...
  return (
    <Sdkv2Context.Provider value={sdk$ as any}>
