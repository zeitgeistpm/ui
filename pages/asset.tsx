    ...
    <>
      ...
      <div className="flex">
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-center h-ztg-38 bg-sky-300 text-black dark:bg-sky-700 dark:text-white  px-ztg-10 font-kanit text-ztg-22-120 font-bold rounded-ztg-5">
            <div
