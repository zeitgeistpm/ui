      ...
      <div className="relative max-h-[90vh] w-full overflow-hidden rounded-xl border-2 border-ztg-primary-200/30 bg-white/95 shadow-2xl backdrop-blur-lg sm:min-w-[580px] sm:max-w-[580px]">
        ...
        <div className="relative border-b-2 border-ztg-primary-200/30 bg-gradient-to-r from-ztg-primary-50/80 to-blue-50/80 px-6 py-4 backdrop-blur-sm">
          ...
          <button
            ...
            className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-lg border-2 border-ztg-primary-200/30 bg-white/60 text-ztg-primary-700 backdrop-blur-sm transition-all hover:bg-ztg-primary-100/80 hover:text-ztg-primary-900"
            aria-label="Close"
          >
            <MdClose size={20} />
          </button>
        ...
        >
          <div className="relative space-y-6 pl-8">
            ...
            <div className="absolute bottom-2 left-[11px] top-2 w-0.5 bg-gradient-to-b from-ztg-primary-200 via-ztg-primary-300 to-ztg-primary-200" />
            ...
            <div className="relative flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-ztg-primary-700">
                  {marketStart}
                  {marketHistory?.start?.blockNumber > 0 && (
                    <span className="ml-2 text-xs text-ztg-primary-600">
            ...
            <div className="relative flex gap-4">
              <div className="absolute -left-8 flex h-6 w-6 items-center justify-center rounded-full border-2 border-ztg-primary-300 bg-white shadow-sm">
                <MdOutlineStop className="text-ztg-primary-600" size={14} />
              </div>
              <div className="flex-1">
                <div className="mb-1 font-semibold text-ztg-primary-900">
                  Market Closed
            ...
            {marketHistory?.reported && (
              <div className="relative flex gap-4">
                ...
                <div className="flex-1 rounded-lg border-2 border-purple-200/30 bg-purple-50/50 p-3 backdrop-blur-sm">
                  <div className="mb-2">
                    {oracleReported && (
                    ...
                    <div className="text-sm font-medium text-ztg-primary-900">
                      {marketHistory.reported.by ? (
                        <Link
                          href={`/portfolio/${marketHistory.reported.by}`}
                          className="inline-block transition-colors hover:text-ztg-primary-600"
                        >
                          <UserIdentity
                        ...
                        <span className="text-ztg-primary-700">Unknown</span>
                      )}{" "}
                      reported{" "}
                  ...
                  <div className="text-xs text-ztg-primary-600">
            ...
            {marketHistory?.disputes &&
              marketHistory.disputes.map((dispute, idx) => (
                <div key={dispute.timestamp} className="relative flex gap-4">
                  ...
                  <div className="flex-1 rounded-lg border-2 border-orange-200/30 bg-orange-50/50 p-3 backdrop-blur-sm">
                    <div className="mb-2">
            ...
            {marketHistory?.resolved?.resolvedOutcome !== undefined && (
              <div className="relative flex gap-4">
                ...
                <div className="flex-1 rounded-lg border-2 border-emerald-200/30 bg-emerald-50/50 p-3 backdrop-blur-sm">
                  <div className="mb-2">
