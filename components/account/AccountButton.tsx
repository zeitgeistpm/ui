...
type AccountMenuContentProps = {
  ...
  constants: any;
  activeBalance: Decimal | undefined;
  usdcAssetHubBalance: Decimal | undefined;
  polkadotBalance: Decimal | undefined;
  isMobile: boolean;
  dropdownPosition: { right: number; top: number } | null;
};

const AccountMenuContent: FC<AccountMenuContentProps> = ({
  open,
  close,
  setAccountMenuOpen,
  updatePosition,
  ...
  // Track menu open state for scroll locking - now at component scope
  useEffect(() => {
    setAccountMenuOpen(open);
  }, [open, setAccountMenuOpen]);
          ...
          <Menu>
            {({ open, close }) => (
              <AccountMenuContent
                ...
                usdcAssetHubBalance={usdcAssetHubBalance}
