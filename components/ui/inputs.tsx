...
const inputClasses =
  "bg-white/10 text-ztg-14-150 w-full rounded-lg h-ztg-40 p-ztg-8 focus:outline-none text-white/90 placeholder:text-white/90 backdrop-blur-sm transition-all focus:bg-white/15";
